// CLI 설정 (adc.cli.*) — export-domain/output-dir(CSV, doc/31) + scan-domain/window/edge(온디맨드 스캔, doc/33 §7) + register-domain(즉시 등록)
 ...
 * {@code register-domain} = 즉시 등록할 도메인(DB 등록만, Loki 미호출).
 */
